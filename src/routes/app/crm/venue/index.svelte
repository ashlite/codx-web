          ...
          <tr>
            ...
            <td>
              <div class="btn-group">
                ...
                <button class="btn btn-sm btn-warning" on:click={() => globalModal.editVenue(venue)}>
                  <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <button class="btn btn-sm btn-error" on:click={() => globalModal.deleteConfirmation(venue.id, venue.name, 'venue')}>

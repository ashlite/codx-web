<script>
  ...
  function toggleDrawerMenu(){
    toggleMainDrawer.update(value => !value)
  }

</script>

<button use:shortcut={{alt:true, shift:true, code:'KeyH' }} class="btn btn-square btn-outline btn-primary" on:click={() => toggleDrawerMenu()}>
